local VM = VisualManager.Elements

Ext.RegisterConsoleCommand("ror_fj_statue", function(cmd)
	Osi.TeleportTo(CharacterGetHostCharacter(), "cdfacbb7-acf8-4c3e-a5a2-bac8a5b0e5a0")
end)
